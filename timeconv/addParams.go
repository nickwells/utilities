...
func addParams(prog *Prog) param.PSetOptFunc {
	return func(ps *param.PSet) error {
		for _, f := range []func(*Prog, *param.PSet) error{
			addTimezoneParams,
...
func addTimezoneParams(prog *Prog, ps *param.PSet) error {
	const tzGroupname = param.DfltGroupName + "-timezone"
...
// of the program
func addTimeFormattingParams(prog *Prog, ps *param.PSet) error {
	var (
